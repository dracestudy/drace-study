...
public enum RapidEventType {
    ...
    public static boolean conflicting(RapidEventType et1, RapidEventType et2) {
        return et1.isAccessType() && et2.isAccessType() && (et1.isWrite() || et2.isWrite());
    }
