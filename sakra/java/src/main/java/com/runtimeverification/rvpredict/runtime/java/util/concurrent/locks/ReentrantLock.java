...
public class ReentrantLock implements Lock, java.io.Serializable {
    ...
    private static final int RVPREDICT_REENTRANT_LOCK_LOC_ID = RVPredictRuntime.metadata
            .getLocationId("java.util.concurrent.locks.ReentrantLock(ReentrantLock.java:n/a)");
