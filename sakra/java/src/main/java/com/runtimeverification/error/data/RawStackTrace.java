...
public class RawStackTrace implements Atdj {
  /**
   ...
   */
  public RawStackTrace(String s) throws JSONException {
    this(new JSONObject(s));
  }

  RawStackTrace(JSONObject jo) throws JSONException {
    components = new java.util.ArrayList<RawStackTraceComponent>();
    for (int _i = 0; _i < jo.getJSONArray("components").length(); ++_i) {
      JSONObject _tmp = jo.getJSONArray("components").getJSONObject(_i);
      components.add(new RawStackTraceComponent(_tmp));
    }
    if (jo.has("thread_id")) {
    ...
    if (jo.has("thread_created_at")) {
      thread_created_at = new RawFrame(jo.optJSONObject("thread_created_at"));
    }
  ...
  public java.util.ArrayList<RawStackTraceComponent> components;
  public String thread_id;
  public String thread_created_by;
  public RawFrame thread_created_at;
}
