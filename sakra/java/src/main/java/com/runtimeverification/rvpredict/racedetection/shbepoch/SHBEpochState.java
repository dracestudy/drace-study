...
public class SHBEpochState extends State {
    ...
    private HashMap<Long, FullAdaptiveVC> writeVariable;
    ...
    public void checkAndAddVariable(long var) {
        if (!readVariable.containsKey(var)) {
            ...
            writeVariable.put(var, new FullAdaptiveVC());
    ...
    public FullAdaptiveVC getWriteVectorClock(long var) {
