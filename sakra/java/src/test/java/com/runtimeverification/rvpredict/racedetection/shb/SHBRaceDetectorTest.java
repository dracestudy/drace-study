...
public class SHBRaceDetectorTest {

    protected static SHBRaceDetector detector;
    ...
    public void setUp() {
        ...
        detector = new SHBRaceDetector(config, metadata);
    }
    ...
    public void testRapidRaceProcess1() {
        ...
        List<Long> expectedRacyEIDs = Arrays.asList(4L);
    ...
    public void testRapidRaceProcess3() {
        ...
        List<RapidEvent> racyEvents = detector.getRacyEvents();
        List<Long> expectedRacyEIDs = Arrays.asList(9L);
    ...
    public void testRapidRaceProcess4() {
        ...
        List<RapidEvent> racyEvents = detector.getRacyEvents();
        List<Long> expectedRacyEIDs = Arrays.asList(6L, 9L, 13L, 16L);
