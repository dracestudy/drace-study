...
public class HBStateTest {

    protected static HBRaceDetector detector;
    ...
    public void setUp() {
        ...
        detector = new HBRaceDetector(config, metadata);
        trace = new ArrayList<>();
    ...
    public void testHBValidWrite1() {
        ...
        int expectedValue = 2;
        int actualValue = detector.state.getThreadClock(1L).get(1);
    ...
    public void testHBValidWrite2() {
        ...
        int expectedValue = 3;
        int actualValue = detector.state.getThreadClock(2L).get(1);
        assertEquals(expectedValue, actualValue);
    }
    ...
    public void testHBValidRead1() {
        ...
        int expectedValue = 1;
        int actualValue = detector.state.getReadVectorClock(1L).get(2);
        assertEquals(expectedValue, actualValue);
    }

    @Test
    public void testHBValidRead2() {
        for (int i = 0; i < 10; i++) {
            detector.analyzeEvent(trace.get(i));
        }

        int expectedValue = 0;
        int actualValue = detector.state.getReadVectorClock(13L).get(2);
        assertEquals(expectedValue, actualValue);
    }
}
