...
public class SynchronousQueue<E> extends AbstractQueue<E>
            ...
            for (;;) {
                ...
                if (h == null || h.mode == mode) {  // empty or same-mode
                    if (timed && nanos <= 0) {      // can't wait
                        ...
                        if (mode == REQUEST) {
                            _rvpredict_sync_queue._rvpredict_remove_element((E) m.item);
                        } else {
                            _rvpredict_sync_queue._rvpredict_add_element((E) s.item);
                        }
    ...
    public SynchronousQueue(boolean fair) {
        transferer = fair ? new TransferQueue<E>(this) : new TransferStack<E>(this);
    }
    ...
    private void readObject(java.io.ObjectInputStream s)
        ...
        if (waitingProducers instanceof FifoWaitQueue)
            transferer = new TransferQueue<E>(this);
        else
            transferer = new TransferStack<E>(this);
    }
