 ...
 * https://github.com/gliga/ekstazi/blob/6567da0534c20eeee802d2dfb8d216cbcbf6883c/org.ekstazi.core/src/main/java/org/ekstazi/maven/MavenCFT.java
 **/
...
public final class MavenCFT implements ClassFileTransformer {
    ...
    private static class MavenMethodVisitor extends MethodVisitor {
        ...
        public void visitCode() {
            ...
            // "com/runtimeverification/rvpredict/instrument/SurefireMojoInterceptor"
            ...
            // Adding in SurefireMojoInterceptor.execute(Object o) right before the
    ...
    /**
     * Method starting bytecode transformation, gets called by
     * instrumentation.retransform().
     */
    public byte[] transform(ClassLoader loader, String className, Class<?> classBeingRedefined,
        ...
        String surefireMojoInterceptor = "com/runtimeverification/rvpredict/instrument/SurefireMojoInterceptor";
