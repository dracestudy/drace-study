...
public class FieldValue implements Atdj {
  /**
   ...
   */
  public FieldValue(String s) throws JSONException {
    this(new JSONObject(s));
  }

  FieldValue(JSONObject jo) throws JSONException {
    offset = jo.getInt("offset");
    value = new LocalVar(jo.getJSONObject("value"));
